                ...
                <div class="pt-4">
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3 mb-6 md:w-1/2 md:mb-0">
                            ...
                            <x-input id="title" class="block mt-1 w-full" type="text" wire:model="title" readonly
                        ...
                        <div class="w-full px-3 mb-6 md:w-1/2">
                            ...
                            <x-select wire:model="category" id="category" class="block mt-1 w-full" readonly>
                        ...
                        <div class="w-full px-3 mb-6 ">
                            ...
                            <x-textarea id="description" class="block mt-1 w-full" wire:model="description" readonly />

                            <x-input-error for="description" class="mt-2" />
                        </div>
                        <div class="w-full px-3 mb-6  md:w-1/2">
                            <x-label for="cover" required :value="__('Cover Buku (jpeg/jpg/png)')" />
                        ...
                        <div class="w-full px-3 mb-6  md:w-1/2">
                            <x-label for="filepdf" required :value="__('File Buku (PDF) ')" />
